...
const content = {
  en: {
    ...
    further: 'Further reading', textbooks: 'Texts for deeper study', classics: 'Russell & Euler: mathematics and philosophy', narratives: 'Novels & history',
    ...
    personal: 'I also enjoy pure mathematics, particularly analysis, as well as history and deductive reasoning. I am especially fond of works by Bertrand Russell and Leonhard Euler.',
  ...
  zh: {
    ...
    further: '延伸阅读', textbooks: '经典教材与进阶参考', classics: '罗素与欧拉：数学与哲学原著', narratives: '优秀小说与历史',
    ...
    personal: '我也喜欢纯数学，尤其是分析学，同时也是历史与推理爱好者，特别喜欢罗素与欧拉的著作。',
      ...
      <div className="layout">
        ...
        <main id="content">
          ...
          <section id="further-reading"><h2>{t.further}</h2><p className="section-note">{t.furtherNote}</p>
            {[{ title: t.textbooks, items: textbooks }, { title: t.classics, items: classics }, { title: t.narratives, items: narratives }].map(group => <div key={group.title}>
              <h3>{group.title}</h3>
