...
export const reading = [
  ...
  {
    url: 'https://manchesteruniversitypress.co.uk/9780719032929/',
    title: { en: 'The Historian’s Craft', zh: '历史学家的技艺 · The Historian’s Craft' },
    credit: 'Marc Bloch · Manchester University Press',
    description: {
      en: 'A foundational reflection on historical inquiry, testimony and source criticism. Read as a methodological perspective, not a definitive account of history.',
      zh: '围绕历史研究、证言与史料批判展开的方法论经典。适合学习如何追问证据，不宜把某一种史学视角当作定论。',
    },
  },
]
...
export const games = [
  ...
  },
  {
    ...
    description: {
      en: 'An investigative game built around identifying people and reconstructing events from clues. A recommendation for evidence-based deduction, not a historical reference. Paid; contains death and violence.',
      zh: '通过线索辨认人物、重建事件的调查推理游戏。推荐的是证据推断机制，而非史实权威性。付费作品，含死亡与暴力情节。',
    },
  },
]
